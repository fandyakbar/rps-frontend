                    ...
                    <Grid item xs={12}>
                      ...
                      <Card>
                            ...
                            <MDButton
                              ...
                              onClick={() => {
                                ...
                                datas.matkul.map((mk) => {
                                  ...
                                  doc.text("PADANG, 2022", xOffset, height - 30, {
                                    align: "center",
                                  });
                                  ...
                                  datass.assessment.map((detailAs, index) => {
                                    ...
                                    datass.datas[index].map((kriteria, insk) => {
                                      ...
                                      dataKriteria[insk] = [
                                        codecpmkDisplay[insk],
                                        kriteria.criteria,
                                      ];

                                      let valuenya = [];
                                      kriteria.detail_category.map((vl, indks) => {
                                        dataKriteria[insk][indks + 2] =
                                          vl.value + "\n(Point: " + vl.point + ")";
                                      });
                        ...
                        <MDBox p={2}>
                          {datas.matkul.map((mk) => (
                            <Table size="small">
                              <TableRow>
                                ...
                                <DataTableHeadCell fontSize="small">
                                  {mk.semester}
                                </DataTableHeadCell>
                              </TableRow>
                              <TableRow>
                          ...
                          <Table>
                            <TableRow>
                              <DataTableBodyCell>Daftar CPL yang diampu</DataTableBodyCell>
                            </TableRow>
                            {datas.cpl.map((listcpl) => (
                              <TableRow>
                                <DataTableHeadCell width="5em">{listcpl.name}</DataTableHeadCell>
                              </TableRow>
                            ))}
                          </Table>
                          <Table>
                        ...
                        >
                          <DataTableHeadCell>
                            <MDTypography variant="h6">
                              Bagian 1 Tabel Rencana Assessment
                            </MDTypography>
                          </DataTableHeadCell>
                        </MDBox>
                ...
                <Card>
                  ...
                  <Table>
                    <TableRow>
                      ...
                      {datas.header[indeks].map((head) => (
                        <DataTableHeadCell component="th" align="center">
                          {head.assessment_category.name}
                        </DataTableHeadCell>
                      ))}
                    </TableRow>
                    ...
                    <TableBody>
                      {datas.datas[indeks].map((kriteria) => (
                        <TableRow>
                          ...
                          {kriteria.detail_category.map((dc) => (
                            <DataTableBodyCell>
                              {dc.value}
                              <br /> <b>(Pont : {dc.point})</b>
                            </DataTableBodyCell>
                          ))}
                        </TableRow>
                      ))}
